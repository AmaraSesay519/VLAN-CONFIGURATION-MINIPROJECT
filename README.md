...
**Note:** The Cisco Packet Tracer simulation file (`.pkt`) cannot be previewed directly on GitHub. Please download the file and open it using Cisco Packet Tracer to view and interact with the network simulation.
